...
class EntropyTown1985(models.Model):
...
class LandcoverChangeRatio(models.Model):
    ...
    barrem = models.DecimalField(db_column='Barrem', max_digits=65535, decimal_places=65535, blank=True, null=True)  # Field name made lowercase.
